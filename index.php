<?php include'header.php';?>
	...
	<!-- Home -->
<head>
	<title>Gereja Bethel Injil Sepenuh (GBIS)</title>
</head>
	<div class="home">
							...
							<div class="row">
								<div class="col">
									<div class="home_content_inner">
										<div class="home_title"><h1>GBIS Tj.piayu Batam</h1></div>
										<div class="home_text">
											<!-- <p>GEREJA GBIS MERUPAKAN GERAJA YANG MEMILIKI JEMAAT </p> -->
										</div>
			...
			<div class="row">
					...
					<div class="box working_hours">
						...
						<div class="working_hours_list">
							<ul>
								...
								<h3>	<div>Ibadah Setiap Hari Minggu</div></h3>
								</li>
								<li class="d-flex flex-row align-items-center justify-content-start">
								<h3> <div>Jam : 10:00 s/d Selesai</div><br> </h3>
				...
				<div class="col-lg-4 box_col">
					<div class="box box_emergency">
						...
						<div class="box_emergency_text">Pdt. R, Sinurat, </div>


						 <a href="https://api.whatsapp.com/send?phone=&amp;text=Hallo%20Bapak Pendata Gereja Bethel Injil Sepenuh (GBIS Tj.piayu), Nama : ,%20Saya%20:%20...">
